...
import { BarChartIcon, BellIcon, LineChartIcon, TagIcon } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 gap-10 lg:gap-16">
          <div className="order-2 md:order-1">
            <div className="space-y-8">
              ...
              <FeatureItem icon={<BellIcon className="text-[#e06e34]" size={24} />} title="Justify Your Budget with Confidence" description="Finally, show your CFO exactly where every dollar is going. Turn cost conversations from defensive to strategic." />
